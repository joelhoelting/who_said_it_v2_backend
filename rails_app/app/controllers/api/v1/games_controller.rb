...
class Api::V1::GamesController < ApplicationController
  ...
  def create
    ...
    if @game.valid?
      @game.save
      return render :json => @game.self_with_restricted_game_quotes, :status => :created
    end
  ...
  def update
    ...
    return render :json => { :error_msg => 'Resource cannot be modified' }, :status => :forbidden if @game.completed
